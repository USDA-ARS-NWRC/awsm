...
class awsm():
    ...
    def __init__(self, configFile):
        ...
        if 'ithreads' in self.config['awsm system']:
    ...
    def createLog(self):
        ...
        '''
        # start logging
        if 'log_level' in self.config['awsm system']:
        ...
        # setup the logging
        logfile = None
        if 'log_to_file' in self.config['awsm system']:
