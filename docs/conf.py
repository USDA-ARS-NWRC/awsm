...
project = 'AWSM'
copyright = f"{datetime.now().year}, USDA Agricultural Research Service, Northwest Watershed Research Center"
author = 'Northwest Watershed Research Center'
...
version = get_distribution('awsm').version

# The full version, including alpha/beta/rc tags.
release = get_distribution('awsm').version
...
latex_documents = [
    ('index', 'awsm.tex',
     u'awsm Documentation',
     u'USDA ARS NWRC', 'manual'),
]
